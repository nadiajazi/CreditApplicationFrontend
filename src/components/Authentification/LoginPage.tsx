...
const LoginPage: React.FC = () => {
  ...
  const sendToServer = async () => {
    ...
    setIsLoading(true);
    try {
      const response = await axios.post("http://localhost:8882/api/v1/auth/authenticate", {
            ...
            <div className="space-y-6">
              ...
              <div className="flex items-center justify-between">
                ...
                <div className="text-sm">
                  <a href="#" className="font-medium text-primary-600 hover:text-primary-700 transition-colors duration-300">
                    Forgot password?
                  </a>
                </div>
              </div>
